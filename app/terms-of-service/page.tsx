      ...
      <main className="max-w-4xl mx-auto mt-28 px-4 sm:px-6 py-12 sm:py-16 flex-1 w-full">
        ...
        <div className="rounded-3xl bg-[#130b21]/60 backdrop-blur-xl border border-white/10 p-6 sm:p-10 space-y-8 text-sm text-white/80 leading-relaxed shadow-2xl">
          <section className="space-y-3">
            ...
            <p>
              Welcome to <strong>Dr. Varshney&apos;s Dental Aesthetics</strong>.
              ...
              ), booking an appointment online, or undergoing dental
              consultations at our clinic in Nani Daman, you agree to comply
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white tracking-tight text-purple-300">
              2. Scope of Dental Practice
            </h2>
            <p>
              All clinical consultations, diagnosis, preventive procedures,
              aesthetic dentistry, implants, and surgical treatments are
              conducted by or under the direct supervision of{" "}
              <strong>Dr. Ayush Varshney (B.D.S., Reg. No. A-22861)</strong> and
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white tracking-tight text-purple-300">
              3. Appointment Bookings & Cancellations
            </h2>
            <ul className="list-disc pl-5 space-y-2 text-white/70">
              <li>
                Online appointment submissions are requests subject to clinic
                schedule confirmation.
              </li>
              <li>
                Patients are encouraged to arrive 10 minutes before their
                scheduled time slot.
              </li>
              <li>
                If you need to cancel or reschedule your visit, please contact
                the clinic at least 4 hours in advance.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              The text, treatment guides, service overviews, and FAQ content
              provided on this website are for general informational and
              educational purposes only. They do not constitute formal medical
              diagnosis or advice. A full in-person clinical examination and
              diagnostic x-rays are required prior to any treatment plan.
            </p>
          </section>

          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white tracking-tight text-purple-300">
              5. Payment & Billing Terms
            </h2>
            <p>
              Payment for clinical procedures is due at the time of treatment
              unless a structured multi-phase treatment plan is established. We
              accept Cash, UPI, Credit Cards, and Debit Cards. Price ranges
              indicated on the website are estimates subject to clinical
              evaluation.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Dr. Varshney&apos;s Dental Aesthetics shall not be liable for any
              indirect or consequential damages arising from website technical
              downtime. Clinical treatment outcomes vary based on individual
              oral health conditions and patient compliance with post-treatment
              care instructions.
            </p>
          </section>
          ...
          <section className="space-y-4 pt-4 border-t border-white/10">
            ...
            <p>
              These terms are governed by the laws of India. For any operational
              or legal inquiries:
            </p>
