...
const doctorData = {
    ...
    consultationHours: [
        { day: "Monday – Friday", time: "10:00 AM – 1:00 PM & 4:00 PM – 8:00 PM" },
        { day: "Saturday", time: "10:00 AM – 1:00 PM & 4:00 PM – 8:00 PM" },
        { day: "Sunday", time: "Closed (Emergency Cases Only)" }
    ],
    email: "dr.varshneydental@gmail.com",
    phone: "+91 79774 54648",
    location: "Shop No. 105, Dutt Sagar Appt. Above IDBI Bank, Airport Road, Nani Daman"
};
...
export default function DoctorProfile() {
    return (
        <section className="relative min-h-[85vh] lg:min-h-[80vh] py-8 lg:py-12 overflow-hidden bg-[#090611] border-t border-[#35063e]/20 flex items-center">
                    ...
                    >
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-sm sm:text-base font-semibold text-purple-300 tracking-wide">
                                B.D.S. (Dental Surgeon) · Reg. No. A-22861
                            </p>
                        </div>
                        ...
                        >
                            ...
                            {/* Panel 3: Consultation Hours (spans full width on small screens, full width on larger) */}
                            {/* <motion.div
                                variants={{
                                    hidden: { opacity: 0, y: 20 },
                                    show: { opacity: 1, y: 0, transition: { duration: 0.5, ease: "easeOut", delay: 0.1 } }
                                }}
                                className="sm:col-span-2 p-4 rounded-2xl bg-gradient-to-b from-[#120a24]/40 to-[#0a0516]/60 border border-white/10 backdrop-blur-[16px] shadow-[0_8px_30px_rgba(0,0,0,0.35),_inset_0_1px_0_rgba(255,255,255,0.05)] hover:border-purple-500/35 transition-all duration-300 group"
                            >
                                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                                    <div className="flex items-start gap-2.5 shrink-0">
                                        ...
                                        <span className="text-[9px] text-purple-300 font-bold uppercase tracking-wider block sm:hidden">Consultation Hours</span>
                                    </div>
                                    <div className="flex-1 grid grid-cols-1 xs:grid-cols-3 gap-1.5">
                                        {doctorData.consultationHours.map((slot, idx) => (
                                            <div key={idx} className="text-left">
                                                <p className="text-[10px] font-bold text-white/80 group-hover:text-white transition-colors">{slot.day}</p>
                                                <p className="text-[10px] text-white/50 leading-relaxed">{slot.time}</p>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                        ...
                        {/* CTA: Book Appointment on WhatsApp - Compact */}
                        <div className="pt-2">
                            <motion.a
                                href="https://wa.me/917977454648?text=Hi%20Dr.%20Varshney,%20I%20would%20like%20to%20book%20an%20appointment."
                                target="_blank"
