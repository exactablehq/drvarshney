...
export const doctorsData: DoctorProfileData[] = [
  {
    ...
    experience:
      "Chief Dental Surgeon at Dr. Varshney's Dental Aesthetics · 3+ Years of Clinical Practice (Dental Surgeon)",
    education: "B.D.S. from Gujarat University ",
    specialization:
      "Aesthetic & Restorative Dentistry, Implantology, Root Canal Therapy",
  ...
  },
  {
    ...
    experience:
      "3rd Rank M.D.S. Gujarat University · National Best Poster Winner (ISPPD 2023)",
    education: "M.D.S. (GDC Ahmedabad) · B.D.S. (GDC Jamnagar)",
    specialization:
      "Conscious Sedation (Nitrous Oxide), GA Rehabilitation, Zirconia Crowns & Pediatric Dentistry",
    ...
    image: "doctors/poorav-patel.png",
  },
  {
    ...
    specialization:
      "Self-Ligating Braces, Invisible Aligners (Orthodontics), TADs",
    ...
    image: "doctors/aakash-parmar.png",
  },
  {
    ...
    image: "doctors/vishal-rohit.png",
  },
  {
    ...
    specialization:
      "Facial Trauma, Orthognathic Surgery, TMJ Disorders & Maxillofacial Procedures",
    ...
    image: "doctors/kunjan-patel.png",
  },
  {
    name: "Dr. Het M. Shah",
    ...
    experience:
      "Dr. R. Ahemad National Student Award Winner · 5 Registered Copyrights",
    education: "M.D.S. (Oral & Maxillofacial Surgery) · B.D.S.",
    specialization:
      "Dental Implants, Maxillofacial Trauma, Oral Pathology & TMJ Disorders",
  ...
  },
  {
    ...
    education:
      "M.D.S. Periodontology & Implantology (Karnavati School of Dentistry) · B.D.S. (Dharamsinh Desai University)",
    specialization:
      "Periodontology, Dental Implantology, Bone Grafting & Laser Dentistry",
  ...
  },
  {
    ...
    experience:
      "2+ Years of Clinical Experience in Prosthodontics & Restorative Dentistry",
    education: "M.D.S. Prosthodontics (2024) · B.D.S. (2018)",
    specialization:
      "Prosthodontics, Dental Implantology, Full Mouth Rehabilitation & Smile Design",
  ...
  },
  {
    ...
    experience:
      "Gold Medalist in Pediatric Dentistry · Chief Pediatric & Preventive Dentist",
    education: "M.D.S. (Pediatric & Preventive Dentistry)",
    specialization:
      "Pediatric Dentistry, Oral Sedation, Nitrous Oxide (Laughing Gas) Sedation & Special Needs Care",
    ...
    image: "doctors/riddhika-shah.png",
  },
  {
    ...
    experience:
      "15+ Years of Clinical Experience in Microscopic Dentistry & Implantology",
    education: "Rajiv Gandhi University (2010)",
    specialization:
      "Advanced Microscopic Dentistry, Root Canal Treatment & Dental Implants",
    ...
    image: "doctors/hitesh-patel.png",
  },
  {
    name: "Dr. Ankur Patel",
  ...
  },
  {
    ...
    experience:
      "AIR 162 (MDS Entrance) · Silver Medalist (BDS 3rd & Final Year) · Senior Lecturer at Vaidik Dental College",
    education:
      "M.D.S. (GDC Ahmedabad) · B.D.S. (2014–2019) · Vallabh Ashram School",
    specialization:
      "Evidence-Based Orthodontics, Dentofacial Orthopedics, Facial Aesthetics & Functional Harmony",
    ...
    image: "doctors/ronit-tiwari.png",
  },
  {
    name: "Dr. Pal Desai",
    ...
    specialization:
      "Oral & Maxillofacial Pathology, Histopathological Evaluation & Early Cancer Detection",
  ...
  },
  {
    ...
    experience:
      "16+ Years of Clinical Experience in Advanced Maxillofacial Imaging",
    education: "Specialist in Oral & Maxillofacial Radiology",
    specialization:
      "CBCT Scan Interpretation, Digital Radiography & Maxillofacial Diagnostic Imaging",
